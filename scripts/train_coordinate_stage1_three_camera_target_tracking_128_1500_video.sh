...
echo "[INFO] Stage 1 three-camera target-tracking baseline"
echo "[INFO] body stereo cameras estimate the target region and target point"
...
"${HOME}/work/robotarm/robotarm_student/scripts/train_coordinate_stage1_plane_128_500.sh" \
  --run_name three_camera_target_tracking_128env_1500iter \
  "$@"
