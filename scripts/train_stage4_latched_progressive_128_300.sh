...
if [[ ! -s "${BEST_FILE}" ]]; then
  echo "[ERROR] Latched progressive Stage-4 training needs a starting checkpoint."
...
export MT4_REACH_STAGE_LATCH_WEIGHT="${MT4_REACH_STAGE_LATCH_WEIGHT:-1.5}"
export MT4_REACH_PROGRESSIVE_STAGE_WEIGHT="${MT4_REACH_PROGRESSIVE_STAGE_WEIGHT:-0.8}"
...
export MT4_REACH_STAGE3_TIME_PRESERVE_WEIGHT="${MT4_REACH_STAGE3_TIME_PRESERVE_WEIGHT:-0.9}"
...
echo "[INFO] Latched progressive Stage-4 training for ${TASK_NAME}"
...
echo "[INFO] near_terminal_radius=${MT4_REACH_NEAR_TERMINAL_RADIUS} weight=${MT4_REACH_NEAR_TERMINAL_WEIGHT}"
echo "[INFO] stage_latch_weight=${MT4_REACH_STAGE_LATCH_WEIGHT} progressive_stage_weight=${MT4_REACH_PROGRESSIVE_STAGE_WEIGHT}"
echo "[INFO] stage3_time_preserve=${MT4_REACH_STAGE3_TIME_PRESERVE_WEIGHT}"
echo "[INFO] terminal_success_quality=${MT4_REACH_TERMINAL_SUCCESS_QUALITY_WEIGHT} success_bonus=${MT4_REACH_SUCCESS_BONUS}"
