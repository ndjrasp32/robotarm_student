...
if [[ ! -s "${BEST_FILE}" ]]; then
  echo "[ERROR] Weighted Stage-4 balance training needs a starting checkpoint."
...
export MT4_REACH_STAGE3_TIME_PRESERVE_WEIGHT="${MT4_REACH_STAGE3_TIME_PRESERVE_WEIGHT:-1.6}"
...
echo "[INFO] Weighted Stage-4 balance training for ${TASK_NAME}"
