...
if [[ ! -s "${BEST_FILE}" ]]; then
  echo "[ERROR] Near-terminal Stage-4 training needs a starting checkpoint."
...
export MT4_REACH_STAGE3_TIME_PRESERVE_WEIGHT="${MT4_REACH_STAGE3_TIME_PRESERVE_WEIGHT:-1.2}"
...
echo "[INFO] Near-terminal Stage-4 training for ${TASK_NAME}"
